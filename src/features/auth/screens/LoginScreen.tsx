...
export default function LoginScreen({ navigation, route }: Props) {
  ...
  return <AuthScreenLayout><View style={styles.stack}>
    ...
    <AuthField autoComplete="email" editable={!busy} icon={<Mail color="#746F7E" size={19} />} keyboardType="email-address" label="Email" onChangeText={setEmail} placeholder="ban@email.com" value={email} />
    <AuthField autoComplete="current-password" editable={!busy} icon={<LockKeyhole color="#746F7E" size={19} />} label="Mật khẩu" onChangeText={setPassword} password placeholder="Nhập mật khẩu" value={password} />
...
const styles = StyleSheet.create({ stack: { gap: 16 }, options: { flexDirection: "row", justifyContent: "space-between", alignItems: "center" }, remember: { color: "#625B6B", fontSize: 13, fontWeight: "600" }, link: { color: "#6B19FF", fontSize: 14, lineHeight: 21, fontWeight: "700" }, google: { minHeight: 52, borderWidth: 1, borderColor: "#DDD4EA", borderRadius: 12, backgroundColor: "#FFFFFF", flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 10 }, googleMark: { color: "#4285F4", fontSize: 21, fontWeight: "800" }, googleText: { color: "#343042", fontSize: 15, fontWeight: "700" }, divider: { flexDirection: "row", alignItems: "center", gap: 12 }, line: { flex: 1, height: 1, backgroundColor: "#E4DDEA" }, dividerText: { color: "#91899B", fontSize: 13, fontWeight: "600" }, bottom: { color: "#625B6B", textAlign: "center", fontSize: 14, lineHeight: 22, fontWeight: "500" }, linkCenter: { color: "#6B19FF", textAlign: "center", fontSize: 14, fontWeight: "700" }, mutedCenter: { color: "#746F7E", textAlign: "center", fontSize: 14, fontWeight: "600" } });
